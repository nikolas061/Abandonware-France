...
- La faisabilite runtime VQA est auditee separement: elle confirme les 1955
  ...
  propre ajoute `MOVIES:0003:d0b3011f` et valide 1130/1130 frames. Le rapport
  ...
  1675/1675 frames. La racine runtime atteint 1894/1955 payloads; le builder
  ecrit maintenant 66/66
  MIX runtime partiels dans `mod_mix_vqa_fullhd/`; 61 payloads restent
...
`replacement_entries=1894/1955`, `applied_replacements=1840/1955`,
`deferred_replacements=54`, `missing_replacements=61`,
`output_archives=66/66` et `output_bytes=42652495315`.
