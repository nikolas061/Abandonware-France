...
- La faisabilite runtime VQA est auditee separement: elle confirme les 1955
  ...
  suivant ajoute `L19_BCI:0005:4732b185` et valide 1256/1256 frames. Le rapport
  ...
  1675/1675 frames. La racine runtime atteint 1895/1955 payloads; le builder
  ecrit maintenant 66/66 MIX runtime partiels dans `mod_mix_vqa_fullhd/`; 60
  payloads restent
...
`replacement_entries=1895/1955`, `applied_replacements=1841/1955`,
`deferred_replacements=54`, `missing_replacements=60`,
`output_archives=66/66` et `output_bytes=43050922081`.
