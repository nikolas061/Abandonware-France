...
- La faisabilite runtime VQA est auditee separement: elle confirme les 1955
  ...
  payloads de remplacement et dix batches incrementaux `--missing-only` de
  3, 6, 6, 8, 10, 12, 14, 16, 18 puis 20 payloads, les huit derniers hors
  `L20_BBI`; le rapport de faisabilite agrege maintenant 85547/85547 frames
  ...
  racine runtime atteint 1718/1955 payloads; le builder ecrit maintenant 66/66
  MIX runtime partiels dans `mod_mix_vqa_fullhd/`; 237 payloads restent
...
`fullhd_writer_validated_frames=85547/85547`, `exact_block_ratio=0.909090`),
...
`replacement_entries=1718/1955`, `applied_replacements=1667/1955`,
`deferred_replacements=51`, `missing_replacements=237` et
