...
- La faisabilite runtime VQA est auditee separement: elle confirme les 1955
  ...
  materialisation compacte produit aussi 112 payloads complets sous 36 Mo dans
  `L20_BBI.MIX` depuis le rapport compact precedent et les budgets oversized
  de base et compact courant, 9579 frames, 19158 chunks roundtrip,
  2835698664 -> 626263698 octets (`saved_ratio=0.779150`). Le builder runtime
  ...
  `replacements_vqa_fullhd_lcw_compact/`, applique 387/407 remplacements,
  descend les differes de 101 a 20 et laisse
  `required_reduction_bytes=1732232639` dans le budget oversized cible.
...
112 payloads compacts complets: `entries_written=112`, `frames=9579`,
`chunk_roundtrip_failures=0`, `saved_bytes=2209434966`,
`saved_ratio=0.779150`. `output/vqa_runtime_pack_build_lcw_compact_sample/`
confirme que ces payloads sont maintenant consommables en overlay:
`overlay_replacements=112`, `applied_replacements=387/407`,
`deferred_replacements=20`, `output_bytes=4294195070`; les 112 lignes compactes
...
`required_reduction_bytes=1732232639` pour les 20 payloads differes de
`L20_BBI.MIX`.
