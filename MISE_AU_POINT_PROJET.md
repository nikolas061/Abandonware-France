...
- La faisabilite runtime VQA est auditee separement: elle confirme les 1955
  ...
  payloads de remplacement et huit batches incrementaux `--missing-only` de
  3, 6, 6, 8, 10, 12, 14 puis 16 payloads, les six derniers hors `L20_BBI`; le
  rapport de faisabilite agrege maintenant 81048/81048 frames 1920x1080
  validees au redecode, et le dernier batch incremental valide 1695/1695 frames
  supplementaires. Un seed
  writer d'archives ajoute 8 payloads cibles, valide 1675/1675 frames, et la
  racine runtime atteint 1680/1955 payloads; le builder ecrit maintenant 66/66
  MIX runtime partiels dans `mod_mix_vqa_fullhd/`; 275 payloads restent
...
`fullhd_writer_validated_frames=81048/81048`, `exact_block_ratio=0.911922`),
...
`replacement_entries=1680/1955`, `applied_replacements=1629/1955`,
`deferred_replacements=51`, `missing_replacements=275` et
