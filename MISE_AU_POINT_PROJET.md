...
- La faisabilite runtime VQA est auditee separement: elle confirme les 1955
  ...
  payloads de remplacement et neuf batches incrementaux `--missing-only` de
  3, 6, 6, 8, 10, 12, 14, 16 puis 18 payloads, les sept derniers hors
  `L20_BBI`; le rapport de faisabilite agrege maintenant 83108/83108 frames
  ...
  racine runtime atteint 1698/1955 payloads; le builder ecrit maintenant 66/66
  MIX runtime partiels dans `mod_mix_vqa_fullhd/`; 257 payloads restent
...
`fullhd_writer_validated_frames=83108/83108`, `exact_block_ratio=0.910757`),
...
`replacement_entries=1698/1955`, `applied_replacements=1647/1955`,
`deferred_replacements=51`, `missing_replacements=257` et
