...
- La faisabilite runtime VQA est auditee separement: elle confirme les 1955
  ...
  1100/1100 frames. Un run unitaire propre ajoute ensuite
  `MOVIES:0000:90fd8446` et valide 1125/1125 frames. Un deuxieme run unitaire
  propre ajoute `MOVIES:0003:d0b3011f` et valide 1130/1130 frames. Le run
  suivant ajoute `L19_BCI:0005:4732b185` et valide 1256/1256 frames, puis
  `SPKSTON2:0008:4119c82e` valide 1294/1294 frames. Le run suivant ajoute
  `L12_CMI:0029:46ece787` et valide 1347/1347 frames, puis
  `L1_DCI:0005:acf90eb1` valide 1378/1378 frames. Le run suivant ajoute
  ...
  `L9_DRI:0001:aeb59d68` valide 2224/2224 frames. Le run suivant ajoute
  `L4_HJI:0016:ccf92ed3` et valide 2021/2021 frames; ce payload reste
  disponible mais differe dans le pack runtime `L4_HJI.MIX` avec trois autres
  payloads trop gros pour la limite body 32 bits. Le run suivant ajoute
  `MOVIES:0002:b3593d3c` et valide 3576/3576 frames; `MOVIES.MIX` applique
  maintenant ses 28/28 remplacements disponibles. Le run suivant ajoute
  `L20_BBI:0029:e80802f3` et valide 92/92 frames; ce payload reste differe
  dans `L20_BBI.MIX` pour la limite body 32 bits. Le run suivant ajoute
  `L20_BBI:0004:83f2786b` et valide 95/95 frames; ce payload reste lui aussi
  differe dans `L20_BBI.MIX`. Le run suivant ajoute
  `L20_BBI:0262:2bf27862` et valide 105/105 frames; ce payload reste lui aussi
  differe dans `L20_BBI.MIX`. Le run suivant ajoute
  ...
  differe dans `L20_BBI.MIX`. Les six runs suivants ajoutent
  `L20_BBI:0178:1c067e6c`, `L20_BBI:0225:24067e6c`,
  `L20_BBI:0272:2c067e6c`, `L20_BBI:0319:34067e6c`,
  `L20_BBI:0366:3c067e6c` et `L20_BBI:0389:44067e6c`; chacun valide
  106/106 frames et reste
  differe dans `L20_BBI.MIX`. Les six runs suivants ajoutent
  `L20_BBI:0094:0c067e6c`, `L20_BBI:0215:23f27862`,
  `L20_BBI:0356:3bf27862`, `L20_BBI:0084:0bf27862`,
  `L20_BBI:0121:13f27862` et `L20_BBI:0309:33f27862`; `0094` valide 106/106
  frames, les cinq autres valident 105/105 frames, et tous restent
  differes dans `L20_BBI.MIX`. Les six runs suivants ajoutent
  `L20_BBI:0059:03f27664`, `L20_BBI:0120:13f27664`,
  `L20_BBI:0167:1bf27664`, `L20_BBI:0214:23f27664`,
  `L20_BBI:0261:2bf27664` et `L20_BBI:0308:33f27664`; chacun valide
  119/119 frames et reste
  differe dans `L20_BBI.MIX`. Les six runs suivants ajoutent
  `L20_BBI:0355:3bf27664`, `L20_BBI:0083:0bf27664`,
  `L20_BBI:0259:2bf27462`, `L20_BBI:0057:03f27462`,
  `L20_BBI:0165:1bf27462` et `L20_BBI:0212:23f27462`; `0355` et `0083`
  valident 119/119 frames, les quatre autres valident 116/116 frames, et tous
  restent differes dans `L20_BBI.MIX`. Les six runs suivants ajoutent
  `L20_BBI:0353:3bf27462`, `L20_BBI:0081:0bf27462`,
  `L20_BBI:0306:33f27462`, `L20_BBI:0118:13f27462`,
  `L20_BBI:0258:2bee7e6c` et `L20_BBI:0117:13ee7e6c`; les quatre premiers
  valident 116/116 frames, les deux derniers valident 176/176 frames, et tous
  restent differes dans `L20_BBI.MIX`. Les six runs suivants ajoutent
  ...
  differes dans `L20_BBI.MIX`. Les quatre derniers runs ajoutent
  `L20_BBI:0024:d3c844e7`, `L20_BBI:0401:46e6b985`,
  `L20_BBI:0403:46e8b985` et `L20_BBI:0400:46e6b785`; ils valident
  respectivement 290/290, 616/616, 675/675 et 1080/1080 frames, et restent
  ...
  1675/1675 frames. La racine runtime atteint 1955/1955 payloads; le builder
  ...
  materialisation compacte produit aussi 140 payloads complets sous 350 Mo dans
  `L20_BBI.MIX` depuis le rapport compact precedent et les budgets oversized
  de base et compact courant, 15708 frames, 31416 chunks roundtrip,
  4798324652 -> 1373848136 octets (`saved_ratio=0.713682`). Le builder runtime
...
`fullhd_writer_validated_frames=136389/136389`, `exact_block_ratio=0.876270`),
...
140 payloads compacts complets: `entries_written=140`, `frames=15708`,
`chunk_roundtrip_failures=0`, `saved_bytes=3424476516`,
`saved_ratio=0.713682`. `output/vqa_runtime_pack_build_lcw_compact_sample/`
confirme que ces payloads sont maintenant consommables en overlay:
`overlay_replacements=140`, `applied_replacements=399/407`,
`deferred_replacements=8`, `output_bytes=4294120522`; les 140 lignes compactes
sont en `replacement_source=overlay`; 132 sont `replacement_ready` et les 8
dernieres sont encore `replacement_deferred_oversize`. Le budget cible
...
`tools/run_lolg95_winedbg_mix_lookup_trace_attempt.py` trace maintenant le hit
lookup `0x4e3d18`, ou `EBX` pointe vers l'archive retenue et `EDX` vers
l'entree MIX. Le run
`output/lolg95_winedbg_mix_lookup_l20_additive_attempt/` force le meme L20,
ecrit correctement `0x5b0948=20` et `0x5b094c=4`, puis capture
`breakpoint_hits=97`, `extracted_rows=97`, `unique_entry_ids=52`. Il reste
`status=gap` parce que `target_hits=0`: les hashes `9fee8483`, `d3c844e7`,
`46e6b785`, `46e6b985`, `46e8b785`, `46e8b985`, `46eab985` et `46eeb585`
