...
- La faisabilite runtime VQA est auditee separement: elle confirme les 1955
  ...
  payloads de remplacement et sept batches incrementaux `--missing-only` de
  3, 6, 6, 8, 10, 12 puis 14 payloads, les cinq derniers hors `L20_BBI`; le
  rapport de faisabilite agrege maintenant 79353/79353 frames 1920x1080
  validees au redecode, et le dernier batch incremental valide 1408/1408 frames
  supplementaires. Un seed
  writer d'archives ajoute 8 payloads cibles, valide 1675/1675 frames, et la
  racine runtime atteint 1664/1955 payloads; le builder ecrit maintenant 66/66
  MIX runtime partiels dans `mod_mix_vqa_fullhd/`; 291 payloads restent
...
`fullhd_writer_validated_frames=79353/79353`, `exact_block_ratio=0.914104`),
...
`replacement_entries=1664/1955`, `applied_replacements=1613/1955`,
`deferred_replacements=51`, `missing_replacements=291` et
