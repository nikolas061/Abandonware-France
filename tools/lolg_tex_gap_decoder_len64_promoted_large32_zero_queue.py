#!/usr/bin/env python3
"""Queue zero runs after len64 plus large32 promotion."""
...
DEFAULT_OUTPUT = Path("output/tex_gap_decoder_len64_promoted_large32_zero_queue")
DEFAULT_SPANS = Path("output/tex_gap_decoder_len64_promoted_large32_run_probe/by_span.csv")
DEFAULT_RUNS = Path("output/tex_gap_decoder_len64_promoted_large32_run_probe/runs.csv")
...
<header>
  <div class="wrap">
    ...
    <div class="sub">Ranks remaining zero runs after len64 plus large32 promotion by position and neighbor context.</div>
  </div>
</header>
<main class="wrap">
  <section class="stats">
...
<script>
const TEX_GAP_DECODER_LEN64_PROMOTED_LARGE32_ZERO_QUEUE = {data_json};
</script>
</body>
</html>
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Queue .tex zero runs after len64 plus large32 promotion."
    )
    ...
    parser.add_argument(
        "--title",
        default="Lands of Lore II .tex Len64 Promoted Large32 Zero Queue",
    )
