#!/usr/bin/env python3
"""Join post-large32 zero-queue runs with source/control operation evidence."""
...
DEFAULT_OUTPUT = Path("output/tex_gap_decoder_len64_promoted_large32_zero_source_probe")
DEFAULT_TARGETS = Path("output/tex_gap_decoder_len64_promoted_large32_zero_queue/queue.csv")
...
<header>
  <div class="wrap">
    ...
    <div class="sub">Joins post-large32 zero-queue runs to source/control operations for selector work.</div>
  </div>
</header>
<main class="wrap">
  <section class="stats">
...
<script>
const TEX_GAP_DECODER_LEN64_PROMOTED_LARGE32_ZERO_SOURCE_PROBE = {data_json};
</script>
</body>
</html>
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Join post-large32 .tex zero queue rows with source/control operation evidence."
    )
    ...
    parser.add_argument(
        "--title",
        default="Lands of Lore II .tex Len64 Promoted Large32 Zero Source Probe",
    )
