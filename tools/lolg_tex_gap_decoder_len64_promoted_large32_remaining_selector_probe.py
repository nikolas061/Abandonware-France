#!/usr/bin/env python3
"""Score selectors for remaining post-medium8 large32 internal zero targets."""
...
DEFAULT_OUTPUT = Path("output/tex_gap_decoder_len64_promoted_large32_remaining_selector_probe")
...
<header>
  <div class="wrap">
    ...
    <div class="sub">Scores source-side selectors for remaining post-medium8 large32 internal zero targets.</div>
  </div>
</header>
<main class="wrap">
  <section class="stats">
...
<script>
const TEX_GAP_DECODER_LEN64_PROMOTED_LARGE32_REMAINING_SELECTOR_PROBE = {data_json};
</script>
</body>
</html>
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Score source-side selectors for remaining post-medium8 large32 internal zero targets."
    )
    ...
    parser.add_argument(
        "--title",
        default="Lands of Lore II .tex Len64 Promoted Large32 Remaining Selector Probe",
    )
