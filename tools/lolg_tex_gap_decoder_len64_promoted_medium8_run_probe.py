#!/usr/bin/env python3
"""Measure zero/nonzero runs after the promoted medium8 gap queue."""
...
DEFAULT_OUTPUT = Path("output/tex_gap_decoder_len64_promoted_medium8_run_probe")
DEFAULT_SPANS = Path("output/tex_gap_decoder_len64_promoted_medium8_gap_queue/spans.csv")
...
<header>
  <div class="wrap">
    ...
    <div class="sub">Splits remaining spans after len64 plus large32 plus medium8 promotion into internal zero and nonzero runs.</div>
  </div>
</header>
<main class="wrap">
  <section class="stats">
...
<script>
const TEX_GAP_DECODER_LEN64_PROMOTED_MEDIUM8_RUN_PROBE = {data_json};
</script>
</body>
</html>
"""
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Measure internal runs after the .tex medium8 promoted replay.")
    parser.add_argument("-o", "--output", type=Path, default=DEFAULT_OUTPUT)
    parser.add_argument("--spans", type=Path, default=DEFAULT_SPANS)
    parser.add_argument("--fixtures", type=Path, default=DEFAULT_FIXTURES)
    parser.add_argument("--title", default="Lands of Lore II .tex Len64 Promoted Medium8 Run Probe")
